     ...
     if(annotate_variants && !filter_ready_vcf) {
        call VariantAnnotation.annotate_variants_wf as AnnotateVariants {
                input:
                    ...
                    bam = select_first([SplitNCigarReads.bam, SplitNCigarLongReads.bam, MarkDuplicates.bam, AddOrReplaceReadGroups.bam, StarAlign.bam, bam]),
                    bam_index = select_first([SplitNCigarReads.bam_index, SplitNCigarLongReads.bai, MarkDuplicates.bai, AddOrReplaceReadGroups.bai, StarAlign.bai, bai]),
